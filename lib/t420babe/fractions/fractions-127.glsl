...
#ifndef T4B_FRACTIONS_127
#define T4B_FRACTIONS_127
...
float fractions_127_map(vec3 p3, float time) {
...
void fractions_127(vec3 p3, float time, peakamp audio) {
