#ifndef T420BABE_WITHDRAWLS_12
#define T420BABE_WITHDRAWLS_12
...
vec3 brick(vec2 pos, vec3 c_brick, vec3 c_mortar) {
  ...
  float brick_width = 0.25 + 0.20;
  float brick_height = 0.08 + 0.20;
  float mortar_thickness = 0.005;
...
// Needs large u_time
void withdrawls_12(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  // if (u_time < 100000.0) {
  //   u_time += 10000.0;
  // }
