...
#ifndef T4B_FRACTIONS_10
#define T4B_FRACTIONS_10
...
void fractions_10(vec3 p3, float time, peakamp audio) {
  vec3 color = vec3(1.0);
  // p3 *= time * 0.5;
  p3 *= 10.0;
  // p3 *= 3.0;
  ...
  // float m = f_10_plot(vec2(p3.x, p3.y), y) * 1.0;
