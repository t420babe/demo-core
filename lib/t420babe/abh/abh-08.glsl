...
float abh_08_map(vec3 p3, float time){
...
void abh_08(vec3 p3, float time, peakamp audio) {
  // time += 800.0;
  vec3 color = vec3(1.0);
  p3 *= time * 0.01;
  // p3.y += 0.5;
