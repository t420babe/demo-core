...
float fractions_55_map(vec3 p3, float time) {
...
void fractions_55(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_55_map(p3, time);
  ...
  float f =  ( rz * fractions_55_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
