...
#ifndef T4B_FRACTIONS_56
#define T4B_FRACTIONS_56
...
float fractions_56_map(vec3 p3, float time) {
...
void fractions_56(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_56_map(p3, time);
  ...
  float f =  ( rz / fractions_56_map(p3, wrap_time(time, 10.0)) ) ;
