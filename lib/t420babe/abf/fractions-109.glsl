...
#ifndef T4B_FRACTIONS_109
#define T4B_FRACTIONS_109
...
float fractions_109_map(vec3 p3, float time) {
...
void fractions_109(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_109_map(p3, time);
  ...
  float f =  ( rz - fractions_109_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
  // float f =  ( rz - fractions_109_map(p3 * 1.0, m) ) ;
