...
float abh_54_map(vec3 p3, float time){
...
void abh_54(vec3 p3, float time, peakamp audio) {
  time += 8.0;
  time += t2s(0, 1, 35);
  // time += 300.0;
  vec3 color = vec3(1.0);
