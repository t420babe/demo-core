...
#ifndef T4B_FRACTIONS_58
#define T4B_FRACTIONS_58
...
float fractions_58_map(vec3 p3, float time) {
...
void fractions_58(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_58_map(p3, time);
  ...
  float f =  ( rz / fractions_58_map(p3, wrap_time(time, 10.0)) ) ;
