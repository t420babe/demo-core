...
#ifndef T4B_FRACTIONS_50
#define T4B_FRACTIONS_50
...
float fractions_50_map(vec3 p3, float time) {
...
void fractions_50(vec3 p3, float time, peakamp audio) {
