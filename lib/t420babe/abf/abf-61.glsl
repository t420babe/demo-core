...
float abf_61_map(vec3 p3, float time) {
...
void abf_61(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz / abf_61_map(p3, wrap_time(time, 10.0)) ) ;
