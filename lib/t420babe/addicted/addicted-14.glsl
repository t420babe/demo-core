...
vec3 addicted_14_12(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 15.0;
  vec3 color = vec3(1.0);
...
vec3 addicted_14_11(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 5.0;
  vec3 color = vec3(1.0);
...
vec3 addicted_14(vec2 pos, float time, peakamp audio, vec2 res) {
  vec3 color = vec3(1.0);
