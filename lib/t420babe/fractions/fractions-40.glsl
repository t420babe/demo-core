...
#ifndef T4B_FRACTIONS_40
#define T4B_FRACTIONS_40
...
float fractions_40_map(vec3 p3, float time) {
...
void fractions_40(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_40_map(p3, time);
  ...
  float f =  ( rz - fractions_40_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
