...
float abf_52_map(vec3 p3, float time) {
...
void abf_52(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz - abf_52_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
