...
#ifndef T4B_FRACTIONS_46
#define T4B_FRACTIONS_46
...
float fractions_46_map(vec3 p3, float time) {
...
void fractions_46(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_46_map(p3, time);
  ...
  float f =  ( rz - fractions_46_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
