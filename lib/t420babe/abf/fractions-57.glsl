...
#ifndef T4B_FRACTIONS_57
#define T4B_FRACTIONS_57
...
float fractions_57_map(vec3 p3, float time) {
...
void fractions_57(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_57_map(p3, time);
  ...
  float f =  ( rz * fractions_57_map(p3, wrap_time(time, 10.0)) ) ;
