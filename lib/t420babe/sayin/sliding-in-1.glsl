#ifndef T420BABE_SLIDING_IN_1
#define T420BABE_SLIDING_IN_1
...
// d5b0306, 20:28
void sayin_sayin_sliding_in_1(vec2 pos, float u_time, peakamp audio, out vec3 color) {
  ...
  pct = star_sliding(pos, 5, audio.bandpass * 5.0);
  color /= sharp(pct);
}
