...
#ifndef T4B_FRACTIONS_42
#define T4B_FRACTIONS_42
...
float fractions_42_map(vec3 p3, float time) {
...
void fractions_42(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_42_map(p3, time);
  ...
  float f =  ( rz - fractions_42_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
