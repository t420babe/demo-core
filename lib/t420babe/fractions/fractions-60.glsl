...
#ifndef T4B_FRACTIONS_60
#define T4B_FRACTIONS_60
...
float fractions_60_map(vec3 p3, float time) {
...
void fractions_60(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_60_map(p3, time);
  ...
  float f =  ( rz / fractions_60_map(p3, wrap_time(time, 10.0)) ) ;
