...
#ifndef T420BABE_CHOICE_27
#define T420BABE_CHOICE_27
...
float choice_27_map(vec3 pos, float time, peakamp audio){
...
vec3 choice_27(vec2 pos, float time, peakamp audio) {
  // 365.0
