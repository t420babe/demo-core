...
vec3 aa_13_10(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 5.0;
  vec3 color = vec3(1.0);
...
vec3 aa_13_11(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 5.0;
  vec3 color = vec3(1.0);
...
vec3 aa_13(vec2 pos, float time, peakamp audio, vec2 res) {
  vec3 color = vec3(1.0);
  ...
  color_0 = aa_10(pos, u_at, audio, u_resolution);
  color_1 = aa_11(pos, u_at, audio, u_resolution);
