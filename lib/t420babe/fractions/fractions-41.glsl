...
#ifndef T4B_FRACTIONS_41
#define T4B_FRACTIONS_41
...
float fractions_41_map(vec3 p3, float time) {
...
void fractions_41(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_41_map(p3, time);
  ...
  float f =  ( rz - fractions_41_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
