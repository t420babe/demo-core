...
#ifndef T4B_FRACTIONS_112
#define T4B_FRACTIONS_112
...
float fractions_112_map(vec3 p3, float time) {
...
void fractions_112(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_112_map(p3, time);
  ...
  float f =  ( rz / fractions_112_map(p3, wrap_time(time, 10.0)) ) ;
