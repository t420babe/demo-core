// #effect #effectshape #shadershoot #fav1
#ifndef T420BABE_DESTINED_12
#define T420BABE_DESTINED_12
...
void destined_12(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  vec3 n_color;
