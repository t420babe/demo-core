// #effect #effectshape #shadershoot #fav5 #needsvid
//
#ifndef T420BABE_GAZE_04
#define T420BABE_GAZE_04
...
void gaze_04(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  audio.lowpass   *= 1.5;
  audio.highpass  *= 1.0;
  audio.bandpass  *= 1.5;
  audio.notch     *= 1.0;
