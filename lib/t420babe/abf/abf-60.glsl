...
float abf_60_map(vec3 p3, float time) {
...
void abf_60(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz / abf_60_map(p3, wrap_time(time, 10.0)) ) ;
