// Let's Freak (Louie Vega Remix) by SanXero Feat. Mr. V & Louie Vega
// #shadershoot #effect #final #emotionsequence
#ifndef T420BABE_WACK_05
#define T420BABE_WACK_05
...
void wack_05(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  audio.lowpass *= 2.0;
  audio.highpass *= 2.0;
  audio.bandpass *= 2.0;
  audio.notch *= 2.0;
