...
float abf_138_map(vec3 p3, float time) {
...
void abf_138(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz - abf_138_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
