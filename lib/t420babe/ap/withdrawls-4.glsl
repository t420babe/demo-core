#ifndef T420BABE_WITHDRAWLS_4
#define T420BABE_WITHDRAWLS_4
...
// Needs large u_time
void withdrawls_4(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  ...
  // c_brick = c_brick.brg;
  color = brick(sin(pos * u_time * 0.01  * abs(audio.notch)), c_brick, c_mortar);
  // color = 1.0 - color;
}
