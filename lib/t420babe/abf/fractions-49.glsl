...
float fractions_49_map(vec3 p3, float time) {
...
void fractions_49(vec3 p3, float time, peakamp audio) {
  ...
  p3 *= time * log(10.0 * audio.notch * p3.x * log(p3.y)) * cos(p3.x)* 0.3;
