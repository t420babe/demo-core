...
#ifndef T4B_FRACTIONS_107
#define T4B_FRACTIONS_107
...
float fractions_107_map(vec3 p3, float time) {
...
void fractions_107(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_107_map(p3, time);
  ...
  float f =  ( y * rz - fractions_107_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
