...
#ifndef T4B_FRACTIONS_53
#define T4B_FRACTIONS_53
...
float fractions_53_map(vec3 p3, float time) {
...
void fractions_53(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_53_map(p3, time);
  ...
  float f =  ( rz - fractions_53_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
