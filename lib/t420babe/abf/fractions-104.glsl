...
#ifndef T4B_FRACTIONS_104
#define T4B_FRACTIONS_104
...
float fractions_104_map(vec3 p3, float time) {
...
void fractions_104(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_104_map(p3, time);
  ...
  float f =  ( rz - fractions_104_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
