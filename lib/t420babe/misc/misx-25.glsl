// #effect #effectshape #shadershoot #corey #needsvid #igloorave
#ifndef T420BABE_MISX_25
#define T420BABE_MISX_25
...
void misx_25(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  audio.lowpass   *= 1.0;
  audio.highpass  *= 1.0;
  audio.bandpass  *= 1.0;
  audio.notch     *= 2.0;
  ...
  color = vec3(0.235, abs(audio.bandpass) * 0.5, abs(audio.highpass) * 1.5);
