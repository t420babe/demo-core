...
vec3 addicted_16_12(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 15.0;
  vec3 color = vec3(1.0);
...
vec3 addicted_16_15(vec2 pos, float time, peakamp audio, vec2 res) {
...
vec3 addicted_16(vec2 pos, float time, peakamp audio, vec2 res) {
  vec3 color = vec3(1.0);
  ...
  color_0 = addicted_12(pos, time, audio, u_resolution);
  color_1 = addicted_15(pos.yx, time, audio, u_resolution);
