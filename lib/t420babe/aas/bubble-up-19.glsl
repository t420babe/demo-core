...
#ifndef T420BABE_BUBBLE_UP_19
#define T420BABE_BUBBLE_UP_19
...
void bubble_up_19(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  ...
  float n = step( abs( atan(a * 3.1415 * 5.0) ), 0.5 * F.x * abs(audio.notch * 0.40));
