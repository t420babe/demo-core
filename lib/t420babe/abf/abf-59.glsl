...
float abf_59_map(vec3 p3, float time) {
...
void abf_59(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz / abf_59_map(p3, wrap_time(time, 10.0)) ) ;
