// ~ 58 min in and about all i can handle rn 
// https://www.youtube.com/watch?v=9wbZEPrFd10
#ifndef T4B_FRACTIONS_106
#define T4B_FRACTIONS_106
...
float fractions_106_map(vec3 p3, float time) {
...
void fractions_106(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_106_map(p3, time);
  ...
  float f =  ( rz - fractions_106_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
