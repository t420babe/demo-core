...
float abf_57_map(vec3 p3, float time) {
...
void abf_57(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz * abf_57_map(p3, wrap_time(time, 10.0)) ) ;
