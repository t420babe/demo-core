...
#ifndef T4B_FRACTIONS_54
#define T4B_FRACTIONS_54
...
float fractions_54_map(vec3 p3, float time) {
...
void fractions_54(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_54_map(p3, time);
  ...
  float f =  ( rz - fractions_54_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
