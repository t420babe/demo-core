...
float abf_34_map(vec3 p3, float time) {
...
void abf_34(vec3 p3, float time, peakamp audio) {
  time += 20.0;
  vec3 color = vec3(1.0);
  audio.lowpass   *= 1.0;
  audio.highpass  *= 1.0;
