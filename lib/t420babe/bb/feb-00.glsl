...
vec3 feb_00(vec2 pos, float u_time, peakamp audio) {
  vec3 color = vec3(1.0);
  ...
  // t = 0.0;
  color_1 = misx_07(pos, u_at, audio);
  color_0 = misx_16(pos, u_at, audio);

  color_1 = nye_2021_26(pos, u_at, audio);
  color_0 = day_0_00(pos, u_at, audio);
