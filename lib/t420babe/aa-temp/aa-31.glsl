...
vec3 aa_31_12(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 15.0;
  vec3 color = vec3(1.0);
...
vec3 aa_31_02(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos;
  vec3 color = vec3(1.0);
...
vec3 aa_31(vec2 pos, float time, peakamp audio, vec2 res) {
  vec3 color = vec3(1.0);
