...
#ifndef T4B_FRACTIONS_45
#define T4B_FRACTIONS_45
...
float fractions_45_map(vec3 p3, float time) {
...
void fractions_45(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_45_map(p3, time);
  ...
  float f =  ( rz - fractions_45_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
