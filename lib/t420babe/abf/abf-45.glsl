...
float abf_45_map(vec3 p3, float time) {
...
void abf_45(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz - abf_45_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
