...
#ifndef T420BABE_DESTINED_02
#define T420BABE_DESTINED_02
...
void destined_02(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  say_nothing_none(pos, u_time, audio, color);
  vec3 damier_color = damier(1.50 * pos, u_time);
