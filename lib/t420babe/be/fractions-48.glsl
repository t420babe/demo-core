...
#ifndef T4B_FRACTIONS_48
#define T4B_FRACTIONS_48
...
float fractions_48_map(vec3 p3, float time) {
...
void fractions_48(vec3 p3, float time, peakamp audio) {
  ...
  p3 *= time * cos(p3.y * log(p3.x)) * cos(p3.y)* 1.0;
