...
#ifndef T4B_FRACTIONS_59
#define T4B_FRACTIONS_59
...
float fractions_59_map(vec3 p3, float time) {
...
void fractions_59(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_59_map(p3, time);
  ...
  float f =  ( rz / fractions_59_map(p3, wrap_time(time, 10.0)) ) ;
