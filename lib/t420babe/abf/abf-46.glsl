...
float abf_46_map(vec3 p3, float time) {
...
void abf_46(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz - abf_46_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
