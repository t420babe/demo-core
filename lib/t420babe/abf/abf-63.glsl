...
float abf_63_map(vec3 p3, float time) {
...
void abf_63(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz - abf_63_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
