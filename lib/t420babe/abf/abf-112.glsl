...
float abf_112_map(vec3 p3, float time) {
...
void abf_112(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz / abf_112_map(p3, wrap_time(time, 10.0)) ) ;
