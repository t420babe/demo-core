// #effectshape #shadershoot #fav #needsong #trippy
#ifndef T420BABE_BUBBLE_UP_00
#define T420BABE_BUBBLE_UP_00
...
vec2 cellular2x2(vec2 P) {
  ...
  float K2 = 100.0714285714285;    // K/2
  float jitter = 0.01;
...
void bubble_up_00(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  color = vec3(1.0);
  float zoom = 2.0;
  pos *= zoom;
