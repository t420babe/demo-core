// #effect #effectshape #shadershoot #fav2
#ifndef T420BABE_DESTINED_21
#define T420BABE_DESTINED_21
...
void destined_21(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  float tri = triangle_0(pos * 0.9);
  float circ = circle_1(pos * 2.0, 0.5);
