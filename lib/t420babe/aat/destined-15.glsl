// #effect #shadershoot #fav2 #trippy
#ifndef T420BABE_DESTINED_15
#define T420BABE_DESTINED_15
...
void destined_15(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  vec3 n_color;
  vec2 n_pos = pos.yx;
  n_pos *= 0.05;
  n_pos.x -= 0.13;
  n_pos.y += 0.07;
  float n = cellular_2d(n_pos, u_time, audio, n_color);
