// #effect #trippy #fav #shadershoot
#ifndef T420BABE_BUBBLE_UP_05
#define T420BABE_BUBBLE_UP_05
...
void bubble_up_05(vec2 pos, float u_time, peakamp audio, inout vec3 color) {
  float inv = 1.0;
  float zoom = 1.0 * inv;
  // pos.y -= 0.13;
  pos.y += 0.20 * inv;
  ...
  color *= abs(sin(n * tan(u_time) + 3.14 / 2.0));
