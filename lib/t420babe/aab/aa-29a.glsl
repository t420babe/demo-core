...
vec3 aa_29a_12(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 15.0;
  vec3 color = vec3(1.0);
...
vec3 aa_29a_02(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos;
  vec3 color = vec3(1.0);
...
// 19:25 
vec3 aa_29a(vec2 pos, float time, peakamp audio, vec2 res) {
  vec3 color = vec3(1.0);
  ...
  vec3 color_0 = aa_29a_02(pos_02, u_at, audio, u_resolution);
  vec3 color_1 = aa_29a_12(pos.yx, u_at, audio, u_resolution);
