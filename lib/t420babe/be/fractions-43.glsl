...
#ifndef T4B_FRACTIONS_43
#define T4B_FRACTIONS_43
...
float fractions_43_map(vec3 p3, float time) {
...
void fractions_43(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_43_map(p3, time);
  ...
  float f =  ( rz - fractions_43_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
