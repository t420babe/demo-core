...
// Money's Gone by Gamuel Sori
#ifndef T420BABE_DAY_0_17
#define T420BABE_DAY_0_17
...
vec3 day_0_17(vec2 pos, float u_time, peakamp audio) {
  vec3 color = vec3(1.0);
