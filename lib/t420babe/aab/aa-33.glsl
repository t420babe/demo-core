...
vec3 aa_33_29_12(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos.yx;
  uv *= 15.0;
  vec3 color = vec3(1.0);
...
vec3 aa_33_29_02(vec2 pos, float time, peakamp audio, vec2 res) {
  vec2 uv = pos;
  vec3 color = vec3(1.0);
...
vec3 aa_33_29(vec2 pos, float time, peakamp audio, vec2 res) {
  vec3 color = vec3(1.0);
...
vec3 aa_33(vec2 pos, float time, peakamp audio, vec2 res) {
  vec3 color = vec3(1.0);
  ...
  color = aa_32(pos, u_at * 1.0, audio, u_resolution);
