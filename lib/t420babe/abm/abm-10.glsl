...
vec4 abm_10_08a(vec3 p3, float time, peakamp audio) {
  audio.bandpass  *= 2.0;
  audio.highpass  *= 5.0;
  audio.lowpass   *= 2.0;
  audio.notch     *= 10.0;
...
vec4 abm_10_08b(vec3 p3, float time, peakamp audio) {
  audio.bandpass  *= 2.0;
  audio.highpass  *= 5.0;
  audio.lowpass   *= 2.0;
  audio.notch     *= 10.0;
...
vec4 abm_10_05(vec3 p3, float time, peakamp audio) {
  audio.bandpass  *= 2.0;
  audio.highpass  *= 2.0;
  audio.lowpass   *= 2.0;
  audio.notch     *= 10.5;
...
void abm_10(vec3 p3, float time, peakamp audio) {
  vec3 color = vec3(1.0);
  vec4 color_05 = abm_10_05(p3, time, audio);
  vec4 color_08 = abm_10_08b(p3, time, audio);
