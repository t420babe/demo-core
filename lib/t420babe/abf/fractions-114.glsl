#ifndef T4B_FRACTIONS_114
#define T4B_FRACTIONS_114
...
float fractions_114_map(vec3 p3, float time) {
...
void fractions_114(vec3 p3, float time, peakamp audio) {
  ...
  float rz = fractions_114_map(p3, time);
  ...
  float f =  ( rz - fractions_114_map(p3 * 1.0, wrap_time(time, 10.0)) ) ;
