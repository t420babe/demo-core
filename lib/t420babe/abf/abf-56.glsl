...
float abf_56_map(vec3 p3, float time) {
...
void abf_56(vec3 p3, float time, peakamp audio) {
  ...
  float f =  ( rz / abf_56_map(p3, wrap_time(time, 10.0)) ) ;
