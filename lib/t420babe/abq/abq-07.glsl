...
void abq_07(vec3 p3, float time, peakamp audio) {
  ...
  float b = (rd.y * 0.5 + 0.5) * 1.2;
  vec3 col = t < MAX_T ? vec3(a * 1.5, a * audio.bandpass * 2.0, a * audio.notch * 2.0) : vec3(b, b * audio.notch * b, b);
